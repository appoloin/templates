/*
    File Name   = SimpleLogger
    Date        = 2018-4-5 19:40:07
    Author      = 
    Description =  https://objectcomputing.com/resources/publications/sett/may-2016-boostlog-library/
*/
...
void Logger::addDataFileLog(const std::string& logFileName) 
{
	...
	//time stamp boost::log::expressions::format("[%1%][%2%] %3%")
	sink->set_formatter(
...
void Logger::cleanup()
{
	boost::log::core::get()->remove_all_sinks(); //logging clean up
}